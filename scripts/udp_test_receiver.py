...
FIELDS_SPEC = {
    "metadata": {
        ...
        "navitype": ("Navi Type", "내비게이션 소스 식별자 (예: 'tmap')"),
            ...
            for section, fields in FIELDS_SPEC.items():
                for key in fields:
                    ...
                    if val is not None:
                        ...
                        elif key in ["nRoadLimitSpeed", "nSdiSpeedLimit", "nSdiPlusSpeedLimit", "nSdiBlockSpeed", "nPosSpeed", "gps_speed"]:
                            formatted_val = f"{val} km/h"
                        elif key in ["nSdiDist", "nSdiPlusDist", "nSdiBlockDist", "nTBTDist", "nTBTDistNext", "nTBTNextRoadWidth", "accuracy"]:
