...
class DebugSenderActivity : AppCompatActivity() {
    ...
    private fun setupFields() {
        ...
        addFieldWithHeader("메타데이터 & 기본", "navitype", "내비게이션 소스", "0")
        addFieldWithHeader("메타데이터 & 기본", "carrotCmd", "오픈파일럿 제어 명령", "0")
        addFieldWithHeader("메타데이터 & 기본", "carrotArg", "오픈파일럿 제어 인자", "0")

        // SDI
        addFieldWithHeader("안전운행 (SDI)", "nRoadLimitSpeed", "현재 도로 제한속도", "0")
        addFieldWithHeader("안전운행 (SDI)", "roadcate", "도로종별 (0:고속,1:도,2:일반)", "0")
        addFieldWithHeader("안전운행 (SDI)", "nSdiType", "1차 이벤트 타입", "0")
        addFieldWithHeader("안전운행 (SDI)", "nSdiSpeedLimit", "1차 이벤트 제한속도", "0")
        addFieldWithHeader("안전운행 (SDI)", "nSdiDist", "1차 이벤트 남은 거리", "0")
        addFieldWithHeader("안전운행 (SDI)", "nSdiSection", "구간단속 여부 (1:예, 0:아니오)", "0")
        addFieldWithHeader("안전운행 (SDI)", "nSdiBlockType", "구간단속 상태 (1:시, 2:진, 3:종)", "0")
        addFieldWithHeader("안전운행 (SDI)", "nSdiBlockSpeed", "구간단속 제한 속도", "0")
        addFieldWithHeader("안전운행 (SDI)", "nSdiBlockAverageSpeed", "현재 평균속도", "0")
        addFieldWithHeader("안전운행 (SDI)", "nSdiBlockDist", "구간단속 남은 거리", "0")
        ...
        addFieldWithHeader("경로안내 (TBT)", "szTBTMainText", "회전 안내 텍스트", "0")
        addFieldWithHeader("경로안내 (TBT)", "nTBTDist", "회전 지점 남은 거리", "0")
        addFieldWithHeader("경로안내 (TBT)", "szNearDirName", "1차 진출 지명", "0")
        addFieldWithHeader("경로안내 (TBT)", "szFarDirName", "2차 진출 지명", "0")
        ...
        // Dest
        addFieldWithHeader("목적지 (Dest)", "szGoalName", "목적지 명칭", "0")
        addFieldWithHeader("목적지 (Dest)", "goalPosX", "목적지 경도", "0")
        addFieldWithHeader("목적지 (Dest)", "goalPosY", "목적지 위도", "0")
        addFieldWithHeader("목적지 (Dest)", "nGoPosDist", "목적지 남은 거리(m)", "0")
        addFieldWithHeader("목적지 (Dest)", "nGoPosTime", "목적지 남은 시간(초)", "0")

        // Loc
        addFieldWithHeader("위치 (Location)", "nPosSpeed", "차량 현재 속도 (TMap)", "0")
        addFieldWithHeader("위치 (Location)", "gps_speed", "차량 현재 속도 (GPS)", "0")
        addFieldWithHeader("위치 (Location)", "szPosRoadName", "현재 주행 중 도로 이름", "0")
        addFieldWithHeader("위치 (Location)", "vpPosPointLat", "맵매칭 위도", "0")
        addFieldWithHeader("위치 (Location)", "vpPosPointLon", "맵매칭 경도", "0")
        addFieldWithHeader("위치 (Location)", "nPosAngle", "방위각", "0")
        addFieldWithHeader("위치 (Location)", "accuracy", "GPS 오차", "0")
    }
